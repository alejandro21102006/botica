...
http://localhost:7092/api/v1/inventario/instancia
http://localhost:7092/api/v1/ventas/instancia
http://localhost:7092/api/v1/clientes/instancia
http://localhost:7092/api/v1/carrito/instancia
http://localhost:7092/api/v1/pagos/instancia
http://localhost:7092/api/v1/proveedores/instancia
http://localhost:7092/api/v1/compras/instancia
http://localhost:7092/api/v1/auth/instancia
```
...
7. Probar enrutamiento por Gateway con `lb://inventario`
8. Probar enrutamiento por Gateway con `lb://ventas`
...
- [x] Configuración base para `inventario` y `ventas`
- [ ] Feign
- [ ] Circuit Breaker
- [ ] Seguridad
